...
def calculate_matmul_resource_utilization(m,n,k,tb_m,tb_n,tb_k,wp_m,wp_n,wp_k,l2_cap,sm_count, bytes_per_num, stage_num,arch):
    ...
    l2_hit_rate=L2_hit_rate_flow_sim_reuse_distance(m, n, k, tb_m, tb_n, tb_k, l2_cap, sm_count, bytes_per_num, stage_num)
