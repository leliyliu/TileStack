...
The parent already encodes public product and specification parameters (SM
count, tensor TFLOPS, HBM/L2 BW, frequencies) for the Blackwell GB202 desktop
class. This subclass adds:
...
Public product/specification sources (verified 2026-04-26):
