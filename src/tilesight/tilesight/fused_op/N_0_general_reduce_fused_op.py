...
def calculate_N_0_general_ruduce_resource_utilization(out_shape,reduction_shape,out_axis_mapping,reduction_axis_mapping,out_tb_shape,dim_threads,bytes_per_num, arch,mem_levels,compute_at=1):
