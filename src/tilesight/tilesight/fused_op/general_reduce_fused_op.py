...
def calculate_general_ruduce_resource_utilization(out_shape,reduction_shape,out_axis_mapping,reduction_axis_mapping,out_tb_shape,dim_threads,bytes_per_num, arch,mem_levels,compute_at=1):
# ret=calculate_N_N_elementwise_resource_utilization([20480,20480],[10,160],[10,10], 4,chip,conv_levels)
    ...
    # out_axis_mapping, out_tb_shape, spatial_grids, in1_tb_spatial_shape, in2_tb_spatial_shape, in1_tb_reduction_shape, in2_tb_reduction_shape,L2_Cap, SM_Count,mem_levels
    # test_code = '''
    ...
    smem_l1_io+=(np.prod(spatial_grids)*thread_per_tb*np.prod(out_thread_shape)*out1_level[1])*bytes_per_num
