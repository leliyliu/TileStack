...
class H100_NVL(Arch):
    ...
    def set_to_spec(self):
        """
        Configures H100_NVL to its official specification parameters.
        This method sets the hardware's fixed parameters and instantiates ComputeUnit objects.
        """
        self.core = "H100_NVL"
        self.sm_count = 132
        self.freq = 1.785 * 1e9  # Core frequency (in Hz); subclasses will set this.
    ...
    def set_to_microbench(self):
        """
        Configures H100_NVL for microbenchmarking.
        This method updates relevant parameters for microbenchmarking scenarios.
        """

        self.freq = 1.29 * 1e9  # Set operating frequency
    ...
    def set_to_ncu(self):
        ...
        """
        self.freq = 1.04 * 1e9  # Set operating frequency based on NCU data
