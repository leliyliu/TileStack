...
class A100_SXM(Arch):
    ...
    def set_to_spec(self):
        ...
        self.core = "A100_SXM"
        self.sm_count = 108
        self.freq = 1.41 * 1e9  # Core frequency (in Hz); subclasses will set this.

        self.ddr_bandwidth = 1935 * 1e9
        self.ddr_capacity = 80 * (1024**3)
        self.l2_bandwidth = 5288 * 1e9  # 96* self.max_freq * 2 * 32 # no compression, 2 sectors/cycle?, 95???
        self.l2_capacity = 40 * (1024**2)  # H100 with dup
